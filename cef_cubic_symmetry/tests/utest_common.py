...
class CommonTests(unittest.TestCase):
    ...
    def test_get_paths(self):
        self.assertEqual(os.path.join(common.BASE_DIR, 'energy_datafiles\\YNi2_Tm\\energy_YNi2_Tm.dat'),
                         common.get_paths(common.path_to_energy_datafiles, 'energy', 'dat', 'YNi2', 'Tm'))
        self.assertEqual(os.path.join(common.BASE_DIR, 'energy_datafiles\\YNi2_Tm\\energy_YNi2_Tm_w+1.000.dat'),
                         common.get_paths(common.path_to_energy_datafiles, 'energy', 'dat', 'YNi2', 'Tm', w=1))
        self.assertEqual(os.path.join(common.BASE_DIR, 'energy_datafiles\\YNi2_Tm\\energy_YNi2_Tm_w-1.000.dat'),
                         common.get_paths(common.path_to_energy_datafiles, 'energy', 'dat', 'YNi2', 'Tm', w=-1))
        self.assertEqual(os.path.join(common.BASE_DIR, 'energy_datafiles\\YNi2_Tm\\energy_YNi2_Tm_x+1.000.dat'),
                         common.get_paths(common.path_to_energy_datafiles, 'energy', 'dat', 'YNi2', 'Tm', x=1))
        self.assertEqual(os.path.join(common.BASE_DIR, 'energy_datafiles\\YNi2_Tm\\energy_YNi2_Tm_x-1.000.dat'),
                         common.get_paths(common.path_to_energy_datafiles, 'energy', 'dat', 'YNi2', 'Tm', x=-1))
